...
export function InfiniteMovingCardsDemo() {
  return (
    <>
      <div className="h-[40rem] flex flex-col gap-8 antialiased bg-white dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
